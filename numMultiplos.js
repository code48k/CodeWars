...
let result = Multiplo(2, 6); // AQUÍ TENEMOS UNA VARIABLE, QUE DENTRO DE ELLA, LLAMAMOS A LA FUNCIÓN, Y LA EJECUTAMOS CON DOS ARGUMENTOS, PARA PASARLO COMO PARAMETROS A LA FUNCIÓN 'Multiplo(2, 6)'.
