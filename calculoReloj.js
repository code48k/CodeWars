...
let calculo = calculoReloj(1, 0, 0); // DECLARAMOS UNA VARIABLE 'calculo', Y LLAMAMOS A ESA FUNCIÓN 'calculoReloj(1, 0, 0)', PARA EJECUTARLA DESPUÉS, QUE REALIZE LOS CALCULO ATRAVÉS DE LOS ARGUMENTOS ASIGNADOS, CALCULARÁ SOLO UNA HORA.
