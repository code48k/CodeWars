...
let angulo3; // TENEMOS QUE CALCULARLO, SABEMOS QUE LA SUMA DE TODOS LOS ÁNGULOS TIENE QUE DAR EN LA SUMA 180º, POR LO CUAL, EL OTRO SERÍA 90º Y SERÍA UN TRIÁNGULO EQUILÁTERO. 

function triangulo(a, b){ // DOS PARAMETROS QUE VIENE DE LLAMADA DE LA FUNCIÓN.

    let calculo = 180 - (a + b); // 180º SERÍA EL TOTAL DE LA SUMA DE LOS ÁNGULOS DEL TRIÁNGULO, 'a + b' SON DE 90º, EL OTRO TENDRÍA OTROS 90º PARA FORMAR UN TRIÁNGULO EQUILÁTERO.
